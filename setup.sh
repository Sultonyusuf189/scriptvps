...
IPVPS=$(curl -sS https://raw.githubusercontent.com/Sultonyusuf189/scriptvps/main/ip | grep $MYIP | awk '{print $4}')
if [[ $MYIP == $IPVPS ]]; then
domain
Casper2
sfvpn
...
res1() {
wget https://raw.githubusercontent.com/kotajakarta/script/main/install/rmbl.sh && chmod +x rmbl.sh && ./rmbl.sh
clear
}
res2() {
wget https://raw.githubusercontent.com/kotajakarta/script/main/install/rmbl1.sh && chmod +x rmbl1.sh && ./rmbl1.sh
clear
}
clear
cd
...
echo -e "${BIBlue}╰══════════════════════════════════════════╯${NC}"
echo -e "${BIBlue}╭══════════════════════════════════════════╮${NC}"
echo -e "${BIBlue}│  [ 1 ]  \033[1;37mDomain kamu sendiri & Random SlowDNS       ${NC}"
echo -e "${BIBlue}│  [ 2 ]  \033[1;37mDomain Yang Punya Script & Random SlowDNS     ${NC}"
echo -e "${BIBlue}│  [ 3 ]  \033[1;37mDomain Kamu Sendiri & Domain SlowDNS Kamu Sendiri    ${NC}"
echo -e "${BIBlue}╰══════════════════════════════════════════╯${NC}"
until [[ $domain =~ ^[132]+$ ]]; do 
...
echo -e "${BIBlue}╰══════════════════════════════════════════╯${NC}"
echo -e "${BIBlue}╭══════════════════════════════════════════╮${NC}"
echo -e "${BIBlue}│  [ 1 ]  \033[1;37mDomain satantech.cloud       ${NC}"
echo -e "${BIBlue}╰══════════════════════════════════════════╯${NC}"
...
clear
echo -e  "${BIBlue}╭══════════════════════════════════════════╮${NC}"
echo -e  "${BIBlue}│  \033[1;37mContoh subdomain anjay.satantech.cloud            ${BIBlue}│${NC}"
echo -e  "${BIBlue}│    \033[1;37manjay jadi subdomain kamu               ${BIBlue}│${NC}"
echo -e  "${BIBlue}╰══════════════════════════════════════════╯${NC}"
echo " "
...
clear
echo -e  "${BIBlue}╭══════════════════════════════════════════╮${NC}"
echo -e  "${BIBlue}│  \033[1;37mContoh subdomain anjay.satanfusion.cloud         ${BIBlue}│${NC}"
echo -e  "${BIBlue}│    \033[1;37manjay jadi subdomain kamu               ${BIBlue}│${NC}"
echo -e  "${BIBlue}╰══════════════════════════════════════════╯${NC}"
echo " "
...
clear
echo -e  "${BIBlue}╭══════════════════════════════════════════╮${NC}"
echo -e  "${BIBlue}│  \033[1;37mContoh subdomain xxx.satantech.cloud        ${BIBlue}│${NC}"
...
clear
echo -e  "${BIBlue}╭══════════════════════════════════════════╮${NC}"
echo -e  "${BIBlue}│  \033[1;37mContoh subdomain xxx.sfusion.cloud       ${BIBlue}│${NC}"
echo -e  "${BIBlue}│    \033[1;37mxxx jadi subdomain kamu               ${BIBlue}│${NC}"
echo -e  "${BIBlue}╰══════════════════════════════════════════╯${NC}"
echo " "
until [[ $dn4 =~ ^[a-zA-Z0-9_.-]+$ ]]; do
...
clear
wget https://raw.githubusercontent.com/kotajakarta/script/main/tools.sh &> /dev/null
chmod +x tools.sh 
bash tools.sh
start=$(date +%s)
...
res3() {
wget https://raw.githubusercontent.com/kotajakarta/script/main/install/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
clear
}

res4() {
wget https://raw.githubusercontent.com/kotajakarta/script/main/install/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
clear
}

res5() {
wget https://raw.githubusercontent.com/kotajakarta/script/main/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
}

res6() {
wget https://raw.githubusercontent.com/kotajakarta/script/main/install/set-br.sh && chmod +x set-br.sh && ./set-br.sh
clear
}

res7() {
wget https://raw.githubusercontent.com/kotajakarta/script/main/sshws/ohp.sh && chmod +x ohp.sh && ./ohp.sh
clear
}

res8() {
wget https://raw.githubusercontent.com/kotajakarta/script/main/menu/update.sh && chmod +x update.sh && ./update.sh
clear
}

res9() {
wget https://raw.githubusercontent.com/kotajakarta/script/main/install/slowdns.sh && chmod +x slowdns.sh && ./slowdns.sh
clear
}

res10() {
wget https://raw.githubusercontent.com/kotajakarta/script/main/install/udp-custom.sh && chmod +x udp-custom.sh && bash udp-custom.sh
clear
}

echo -e "${BIBlue}╭══════════════════════════════════════════╮${NC}"
echo -e "${BIBlue}│ ${BGCOLOR}     PROCESS INSTALLED SSH  VPN         ${NC}${BIBlue} │${NC}"
echo -e "${BIBlue}╰══════════════════════════════════════════╯${NC}"
fun_bar 'res3'
